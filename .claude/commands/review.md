---
description: Review code changes for Lumin-specific patterns, security, and common mistakes
---

Review the current changes (staged or working directory) with focus on Lumin-specific patterns and common mistakes.
...
## Step 2: Check Lumin-Specific Patterns
